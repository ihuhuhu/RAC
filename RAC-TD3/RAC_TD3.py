...
if __name__ == "__main__":
    ...
    parser.add_argument("--replay_buffer_size", default=2e5, type=int, help='Replay buffer capability')
    ...
    analysis = tune.run(
        ...
        checkpoint_freq=args.checkpoint_freq,  # 每次都保存一下
    )